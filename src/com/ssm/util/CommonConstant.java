...
public class CommonConstant {
	...
	public static final String DATE_SECOND_FORMAT ="yyyyMMddHHmmss";
	...
	/** 活期宝标的状态：已初审 */
	public static final int HUOQIBAO_STATUS_WAITING = 11;
	/** 标的状态：投标中 */
	public static final int BORROW_STATUS_TENDERING = 2;
	/** 活期宝标的状态：投标中 */
	public static final int HUOQIBAO_STATUS_TENDERING = 12;
	/** 标的状态：已满标 */
	 ...
	 * 短信内容签名
	 */
	public static final String SMSSIGN = "【好好理财】"; 
	public static final String RETURNSTATUS = "returnstatus";  
	public static final String RESULT = "Result";  
	public static final String SUCCESS = "Success";  
	public static final String FAILD = "Faild"; 
	public static final String WELCOME = "欢迎注册好好理财";
	
	/**
	 * 网站注册地址
	 */
	public static final String LOCALHOST="https://www.haohaolicai.com";
